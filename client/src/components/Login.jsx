...
const Login = () => {
 ...
 const onSubmitHandler = async(e)=>{
  ...
  return (
    <div className='fixed absolute inset-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      
      <motion.form onSubmit={onSubmitHandler}
      className='relative bg-white w-[360px] p-8 rounded-2xl shadow-lg text-slate-500'
      ...
      >
        ...
        <h1 className='text-center text-2xl text-neutral-800 font-semibold'>
          {state}
        </h1>
        ...
        {state === 'Login' && (
          <p className='text-sm text-blue-600 mt-3 cursor-pointer text-right'>
            Forgot password?
          </p>
        )}
